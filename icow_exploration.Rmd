...
* `population`: 232 countries/territories for which there is population data from 1950-- there are 108 countries in the `icow` dataset that became independent after 1950
...
temp4<-temp %>% group_by(ColRulerN, IndViol) %>% 
  summarise(mean1950to1955=mean(`1950-1955`),
            mean1955to1960=mean(`1955-1960`),
            mean1960to1965=mean(`1960-1965`),
            mean1965to1970=mean(`1965-1970`),
            mean1970to1975=mean(`1970-1975`),
            mean1975to1980=mean(`1975-1980`),
            mean1980to1985=mean(`1980-1985`),
            mean1985to1990=mean(`1985-1990`),
            mean1900to1995=mean(`1990-1995`),
            mean1995to2000=mean(`1995-2000`),
            mean2000to2005=mean(`2000-2005`),
            mean2005to2010=mean(`2005-2010`),
            mean2010to2015=mean(`2010-2015`),  
            count=n()
            ) %>% 
